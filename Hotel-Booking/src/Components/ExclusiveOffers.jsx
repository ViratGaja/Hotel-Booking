    ...
    return (
        <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-20'>
            <div className='flex flex-col md:flex-row items-center justify-between w-full'>
                ...
                <button className='group flex items-center font-medium cursor-pointer max-md:mt-12 gap-2'>
                    View All Offeres
                    <img src={assets.arrowIcon} alt="arrow-icon" className='group-hover:translate-x-1 transition-all mt-1' />
                </button>
            </div>
