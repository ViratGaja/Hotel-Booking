        ...
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col lg:flex-row mt-6 gap-6'>
                <div className='lg:w-1/2 w-full'>
                    <img src={mainImage} alt="Room_Image" className='w-full rounded-xl shadow-lg object-cover' />
                </div>
            ...
            <div className='flex flex-col md:flex-row md:justify-between mt-10 '>
                <div className='flex  flex-col'>
                    ...
                    <div className='flex  felx-warp items-center mt-3 mb-6 gap-4'>
            ...
            {/* Hosted By */}
                ...
                <div className='flex flex-col items-start gap-4'>
                    ...
                    <button className='px-6 py-2.5 bg-primary hover:bg-primary-dull text-white rounded transition-all cursor-pointer'>Contact Now</button>
                </div>
